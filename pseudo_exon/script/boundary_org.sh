...
bedtools getfasta -fi db/GRCh38.primary_assembly.genome.fa -bed data/boundary_org/boundary_raw.bed.gz -tab -s > data/boundary_org/boundary_fasta.tsv 2>/dev/null
...
cd ~/bin/maxent
perl score5.pl ~/data/boundary_org/boundary_fasta_5.tsv > ~/data/boundary_org/boundary_fasta_5_score.tsv
perl score3.pl ~/data/boundary_org/boundary_fasta_3.tsv > ~/data/boundary_org/boundary_fasta_3_score.tsv
